...
import {CollectionsPage, AdminCollectionPage} from 'client/pages/admin/collections';
...
const routes = (
    <Route path="admin" component={AdminIndex}>
        ...
        <Route path="collections/:collection_id/:tab" component={AdminCollectionPage}/>
        <Route path="groups" component={Groups}/>
        <Redirect from="groups/:group_id" to="groups/:group_id/users"/>
        <Route path="groups/:group_id/:tab" component={Group}/>
        <Route path="groups/:group_id/users/add" component={CreateOrAddUserDialog}/>
