...
import AdminCollectionProgress from './container/admin/analytics/progress';

import UserIndex from './container/user';
import UserCollections from './container/user/collections';
import UserCollectionCardsList from './container/user/collections/cards/list';
import UserCollectionCard from './container/user/collections/cards/card';
