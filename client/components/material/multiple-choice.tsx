...
import { MultipleChoice as IMultipleChoice } from '../../state/material/types';
...
> {
    ...
    public handleClick(answer_id) {
        ...
        const correct_answers = this.props.material.items.filter(
            ...
            <div>
                ...
                {this.props.material.items.map(item => (
                    <Paper
                        ...
                        zDepth={
                            this.props.answer.some(answerv => answerv === item)
                                ? 5
                                : 1
                        }
                        style={{
                            backgroundColor: this.props.answer.some(
                                answerv => answerv === item
                            )
                                ? '#2980b9'
                                : '#FFFFFF',
                            padding: '2px',
