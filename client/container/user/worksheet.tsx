...
import { push, dialog_close, dialog_open } from '../state/ui/actions';
        ...
        return (
            <div id="worksheet">
                ...
                <Summary
                    ...
                    submit={() => {
                        this.props.dispatch(
                            submit_collection(this.props.collection.meta._id)
                        );
                    }}
                ...
                >
                    <BottomNavigationItem
                        style={{
                            display:
                                first(this.props.collection.material) !==
                            ...
                            this.props.dispatch(
                                push(
                                    '/worksheet/' +
                                        ...
                                        '/material/' +
                                        prev(
                                            this.props.collection.material,
                                            this.props.material_id
                                        )
                                )
                            )}
                    ...
                    <BottomNavigationItem
                        style={{
                            display:
                                last(this.props.collection.material) !==
                                this.props.material_id
                                    ? 'block'
                                    : 'none'
                        }}
