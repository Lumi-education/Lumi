...
import { Material, get_material } from '../state/material/selector';

// action & props-mapping
import { create_material_meta } from '../state/material/actions';
    ...
    init(props: Props) {
        if (!props.material.meta && props.material.material_type) {
            ...
            meta = {
                ...
                value:
                    props.material.material_type === 'sort'
                        ? shuffle(props.material.items)
                        : [],
                score: 0
            };
            // 		break;
