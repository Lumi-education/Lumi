...
export default class AdminGroupCollections extends React.Component<IProps, IComponentState> {
		...
		return (
			<div>
						<List>
							{
								...
								.map(collection => 
									<div>
										<ListItem 
											leftAvatar={<Avatar>{collection.name.substring(0, 3)}</Avatar>}
						...
						<FloatingActionButton 
							onClick={() => { 
								this.props.dispatch( push('/admin/groups/' + this.props.group_id + '/collections/add') );
								}}
							style={{ margin: '20px' }}
						>
							<ContentAdd />
