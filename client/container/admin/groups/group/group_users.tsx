...
export default class AdminGroupUsers extends React.Component<IProps, IComponentState> {
		...
		return (
			<div>
									...
									<div>
										<ListItem 
											...
											rightIconButton={rightIconMenu([
												<MenuItem onClick={() => this.props.dispatch( push('/admin/users/' + user._id ))}>View</MenuItem>,
												<MenuItem onClick={() => this.props.dispatch( rem_group(user._id, this.props.group_id ) )}>Remove</MenuItem>
											])}
										/>
										<Divider inset={true} />
									</div>
						...
						<FloatingActionButton 
							onClick={() => { 
								this.props.dispatch( push('/admin/groups/' + this.props.group_id + '/users/add') );
								}}
							style={{ margin: '20px' }}
						>
							<ContentAdd />
